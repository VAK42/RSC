...
export default function Index() {
  ...
  const fclts = [
    { img: "/app/IMG/RSC/RSC_02.webp", name: "Indoor Sports", path: "/facilities" },
    { img: "/app/IMG/RSC/RSC_04.webp", name: "Outdoor Sports", path: "/facilities" },
    { img: "/app/IMG/RSC/RSC_06.webp", name: "Recreation Sports", path: "/facilities" },
  ];
  return (
